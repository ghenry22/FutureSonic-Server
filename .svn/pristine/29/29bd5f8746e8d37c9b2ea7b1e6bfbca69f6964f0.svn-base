...
<!--<tr><td class="ruleTableHeader"><fmt:message key="help.subsonic_forum.title"/></td><td class="ruleTableCell"><a target="_blank" href="http://forum.subsonic.org/forum/viewforum.php?f=15">forum.subsonic.org (FutureSonic)</a><img style="float:right;margin-left: 10px" alt="Subsonic" src="<c:url value="/icons/subsonic_banner.png"/>"></td></tr>-->
    <tr><td class="ruleTableHeader"><fmt:message key="help.futuresonic_homepage.title"/></td><td class="ruleTableCell"><a target="_blank" href="https://code.google.com/p/futuresonic/">futuresonic</a><img style="float:right;margin-left: 10px" alt="FutureSonic" src="<c:url value="/icons/default/futuresonic_banner.png"/>"></td></tr>
<!--    <tr><td class="ruleTableHeader"><fmt:message key="help.futuresonic_forum.title"/></td><td class="ruleTableCell"><a target="_blank" href="http://forum.futuresonic.org/">forum.futuresonic.org</a> <img style="float:right;margin-left: 10px" alt="FutureSonic" src="<c:url value="/icons/default/futuresonic_banner.png"/>"></td></tr>-->
