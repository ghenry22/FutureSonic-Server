...
<h1>
    ...
    <fmt:message key="futuresonic.title"/>
</h1>
...
<c:url value="https://code.google.com/p/futuresonic/wiki/donate" var="donateUrl"/>

<div style="width:50em; max-width:50em">

<fmt:message key="futuresonic.textbefore"><fmt:param value="${command.brand}"/></fmt:message>
