...
/**
 * Logger implementation which logs to SUBSONIC_HOME/futuresonic.log. <br/>
...
public class Logger {
	...
	private void addEntry(Level level, Object message, Throwable error) {
		...
		try {
			...
			System.err.println("Failed to write to futuresonic.log.");
			x.printStackTrace();
		}
		entries.add(entry);
	...
	public static File getLogFile() {
		...
		return new File(subsonicHome, "futuresonic.log");
	}
