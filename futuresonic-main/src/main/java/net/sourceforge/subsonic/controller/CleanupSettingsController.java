...
public class CleanupSettingsController extends ParameterizableViewController {
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (request.getParameter("reset2FutureSonicFLV") != null) {
        	transcodingDao.reset2FutureSonicFLV();
			map.put("done", true);
        }	        
        if (request.getParameter("reset2FutureSonicWEBM") != null) {
        	transcodingDao.reset2FutureSonicWEBM();
			map.put("done", true);
        }	        
        if (request.getParameter("reset2FutureSonicMP4") != null) {
        	transcodingDao.reset2FutureSonicMP4();
			map.put("done", true);
        }	        
