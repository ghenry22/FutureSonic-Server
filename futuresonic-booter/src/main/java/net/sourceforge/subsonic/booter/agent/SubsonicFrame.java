...
public class SubsonicFrame extends JFrame {
    ...
    public SubsonicFrame(SubsonicAgent subsonicAgent, StatusPanel statusPanel, SettingsPanel settingsPanel) {
        super("FutureSonic Control Panel");
    ...
    private void setupIcons() {
        ...
        try {
            ...
            java.util.List<Image> images = Arrays.asList(
                    toolkit.createImage(Main.class.getResource("/images/futuresonic-16.png")),
                    toolkit.createImage(Main.class.getResource("/images/futuresonic-32.png")),
                    toolkit.createImage(Main.class.getResource("/images/futuresonic-512.png")));
            method.invoke(this, images);
        } catch (Throwable x) {
            // Fallback to old method.
            setIconImage(toolkit.createImage(Main.class.getResource("/images/futuresonic-32.png")));
        }
    }
