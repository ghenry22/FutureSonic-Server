...
public class TrayController implements SubsonicListener {
    ...
    public void showMessage() {
        trayIcon.displayMessage("FutureSonic", "FutureSonic is now running. Click this balloon to get started.",
                TrayIcon.MessageType.INFO);
    }

    private void createActions() {
        openAction = new AbstractAction("Open FutureSonic in Browser") {
            public void actionPerformed(ActionEvent e) {
                subsonicAgent.openBrowser();
            }
        };

        controlPanelAction = new AbstractAction("FutureSonic Control Panel") {
            public void actionPerformed(ActionEvent e) {
